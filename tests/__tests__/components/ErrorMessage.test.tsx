...
describe("ErrorMessage", () => {
  it("renders without crashing", () => {
    const { lastFrame } = render(<ErrorMessage message="Test error" />);
  ...
  it("shows cross icon", () => {
    const { lastFrame } = render(<ErrorMessage message="Error" />);
  ...
  it("truncates long messages", () => {
    ...
    const { lastFrame } = render(<ErrorMessage message={longMessage} />);
