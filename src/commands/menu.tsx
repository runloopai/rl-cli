...
const App: React.FC<AppProps> = ({ onSSHRequest, initialScreen = 'menu', focusDevboxId }) => {
  const { exit } = useApp();
...
export async function runMainMenu(initialScreen: Screen = 'menu', focusDevboxId?: string) {
